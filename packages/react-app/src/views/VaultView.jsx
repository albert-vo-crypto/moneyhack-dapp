...
const BidView = ({
  ...
  const vaultContract = new Contract(vaultAddress, RBFVAULTABI, localProvider);

  const fetchData = async () => {
    const status = await vaultContract.vaultStatus();
    log({ vaultAddress, vaultBalance, status });
  };
  useEffect(() => {
    fetchData();
